...
closed form solution(meaning the only hyperparameter that is necessary to tune is ridge regulator), I made things interesting by using gradient descent instead, giving me a 2d optimization problem.
