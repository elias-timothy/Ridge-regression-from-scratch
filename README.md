...
closed form solution(meaning the only hyperparameter that is necessary to tune is the regularization parameter), I made things interesting by using gradient descent instead.
